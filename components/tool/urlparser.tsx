              ...
              <div>
                ...
                <div className="mt-1 flex items-center justify-between gap-2 rounded-none bg-muted/45 px-2 py-1">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      parsed.protocol && handleCopy(parsed.protocol)
                    }
                  >
              ...
              <div>
                ...
                <div className="mt-1 flex items-center justify-between gap-2 rounded-none bg-muted/45 px-2 py-1">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      parsed.hostname && handleCopy(parsed.hostname)
                    }
                  >
                    <Copy className="w-3 h-3" />
                  </Button>
              ...
              <div>
                ...
                <div className="mt-1 flex items-center justify-between gap-2 rounded-none bg-muted/45 px-2 py-1">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => parsed.origin && handleCopy(parsed.origin)}
                  >
                    <Copy className="w-3 h-3" />
                  </Button>
                </div>
                  ...
                  {parsed.params.map((param, index) => (
                    ...
                    >
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          handleCopy(`${param.key}=${param.value}`)
                        }
                      >
                        <Copy className="w-3 h-3" />
                      </Button>
            ...
            <div>
              ...
              <div className="mt-1 flex items-center justify-between gap-2 rounded-none bg-muted/45 px-2 py-1">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => parsed.href && handleCopy(parsed.href)}
                >
                  <Copy className="w-3 h-3" />
                </Button>
              </div>
