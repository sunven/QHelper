...
import { Copy, Download, Minimize2, Maximize2, Settings2 } from 'lucide-react'
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center gap-1.5">
            <Button
              type="button"
              onClick={() =>
                setState((prev) => ({ ...prev, mode: 'beautify' }))
              }
          ...
          <div className="flex items-center gap-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setState((prev) => ({ ...prev, indentSize: Number(value) }))
              }
            >
      ...
      <div className="mt-2 flex flex-wrap gap-3 text-xs text-slate-600 dark:text-slate-400">
        ...
        <span>
          ...
          {state.input.length > 0
            ? Math.round((1 - state.output.length / state.input.length) * 100)
            : 0}
          %
        </span>
      </div>
