      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            <div
              className="h-36 flex-1 rounded-none border border-border/70"
          ...
          <CardContent className="flex flex-wrap items-end gap-3">
            <div className="flex gap-2">
              <Input
                ...
                value={srcRgb[0]}
                onChange={(e) =>
                  setSrcRgb([e.target.value, srcRgb[1], srcRgb[2]])
                }
                placeholder="R"
                className="w-20"
              />
              <Input
                ...
                value={srcRgb[1]}
                onChange={(e) =>
                  setSrcRgb([srcRgb[0], e.target.value, srcRgb[2]])
                }
                placeholder="G"
                className="w-20"
              />
              <Input
                ...
                value={srcRgb[2]}
                onChange={(e) =>
                  setSrcRgb([srcRgb[0], srcRgb[1], e.target.value])
                }
                placeholder="B"
                className="w-20"
              />
