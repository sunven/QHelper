...
export interface ToolMetadata {
  ...
  // 入口点
  entry: string;                   // SPA 路由入口路径（如 'tools.html#/json'）
...
export const tools: ToolMetadata[] = [
...

  {
    ...
    entry: 'tools.html#/pictureSplicing',
    version: '1.0.0',
...

  {
    ...
    entry: 'tools.html#/colorTransform',
    version: '1.0.0',
    features: ['real_time'],
    status: ToolStatus.STABLE,
  },
...
const loadTool = async (toolId: string) => {
  const tool = await import(`@/components/tool/${toolId}.tsx`);
  return tool.default;
};

// React.lazy 使用
const JsonTool = React.lazy(() => import('@/components/tool/json.tsx'));
```
