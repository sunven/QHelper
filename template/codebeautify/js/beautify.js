...
var CodeBeautify = (function() {
    ...
    //var b = "Javascript";
    var a = function() {
        jQuery("#codeTypeJs").click(function(){
        ...
        jQuery("#codeTypeCss").click(function(){
        ...
        jQuery("#codeTypeHTML").click(function(){
        ...
        jQuery("#codeTypeXML").click(function(){
        ...
        jQuery("#codeTypeSQL").click(function(){
