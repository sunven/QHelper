...
baidu.ed = (function() {
    var d = function() {
        ...
        jQuery("#uniDecode").click(function(){
            jQuery("#srcText").val(jQuery("#srcText").val().replace(/\\U/g, "\\u"));
            jQuery("#rstCode").val(baidu.endecode.uniDecode(jQuery("#srcText").val()));
        });
        jQuery("#utf8Encode").click(function(){
            jQuery("#rstCode").val(encodeURIComponent(jQuery("#srcText").val()))
        });
        jQuery("#utf8Decode").click(function(){
            jQuery("#rstCode").val(decodeURIComponent(jQuery("#srcText").val()))
        });
        jQuery("#base64Encode").click(function(){
            jQuery("#rstCode").val(baidu.endecode.base64Encode(baidu.endecode.utf8Encode(jQuery("#srcText").val())))
        });
        jQuery("#base64Decode").click(function(){
            jQuery("#rstCode").val(baidu.endecode.utf8Decode(baidu.endecode.base64Decode(jQuery("#srcText").val())))
        });
        jQuery("#md5Encode").click(function(){
            jQuery("#rstCode").val(hex_md5(jQuery("#srcText").val()))
        });
        jQuery("#html2js").click(function(){
            jQuery("#rstCode").val(f(jQuery("#srcText").val()));
        });
    };
    var f = function(i) {
